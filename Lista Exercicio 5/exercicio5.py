...
lista_telefonica = [213752, 216732, 221063, 221545, 225583, 229133, 230648, 233222,
...
for telefone in lista_telefonica:
    contato = str(telefone)
    acumulador = 0
    for numero in range(len(contato)):
        if contato[numero - 1] == contato[numero]:
            acumulador = 0
            break
        else:
            acumulador += int(contato[numero])
    if acumulador != 0 and (acumulador % 2) == 0:
        contador += 1
