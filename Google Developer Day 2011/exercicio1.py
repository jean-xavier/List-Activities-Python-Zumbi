...
def count_preposicoes(txt):
	...
	for palavra in txt:
		if palavra[0] in 'zmb' and palavra[-1] not in 'zmb':
...
que terminam numa letra tipo outras. Além disso, se um verbo começa com uma letra tipo outras, o verbo está em
primeira pessoa.
